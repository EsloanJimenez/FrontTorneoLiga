...
export const Header = () => {
   ...
   const getTeamList = async () => {
      const tl = await axios(`https://apitorneoliga.onrender.com/api/team`);
      setTeamList(tl.data);
   }
   ...
   return(
      <div id="home">
          {/* ----- HEADER ----- */}
         <header>
            <span className="navBar" id="btnMain"><FontAwesomeIcon icon={faBars} /><span>Torneo Salome Ureña 2023</span></span> 
