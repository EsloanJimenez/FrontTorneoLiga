...
import teamRed from '../images/teams/teamIbaka.jpg';
...
export const Team6 = () => {
   ...
   const getPlayer = async () => {
      const py = await axios(`${url}viewTeam1/9`);
      setPlayer(py.data);
   }

   const getCounterVisit = async () => {
      const vc = await axios(`${url}countVisitTeam9`);
   ...
   const setCounterVisit = () => {
      axios.post(`${url}countVisitTeam9`, {
         page: 'Salome Ureña'
      })
   }
